"""
Kata 06: Atlassian Agent - Bedrock Solution
...
def search_confluence(query: str, space_key: str = None, max_results: int = 5) -> str:
    ...
    try:
        ...
        for page in pages:
            ...
            full_url = f"{ATLASSIAN_URL}/wiki{page_url}" if page_url else "URL not available"
...
def main():
    ...
    print("=" * 70)
    print(" Kata 06: Atlassian Agent - Bedrock Solution")
