"""
Kata 03b: Browser Automation Tools - Bedrock Solution
...
def create_browser_agent():
    """Create a Strands agent with browser automation tools backed by AWS Bedrock."""
    model = BedrockModel(
...
def main():
    ...
    print(Colors.header(" Kata 03b: Browser Automation Tools - Bedrock Solution"))
